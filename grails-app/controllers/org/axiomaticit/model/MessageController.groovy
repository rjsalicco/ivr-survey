...
class MessageController {
    ...
    def save = {
		...
		messageInstance.data = request.getFile('data').bytes
		messageInstance.contentType = "audio/x-wav"
		messageInstance.fileName = "test.wav"
	...
	def fetch = {
		...
		response.setHeader("Content-disposition", "attachment; filename=${messageInstance.id}")
		response.outputStream << messageInstance.data
	}
